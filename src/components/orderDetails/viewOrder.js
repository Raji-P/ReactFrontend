...
import { getTokenFromSession } from "../Utils/OverAll";
...
export default function PresentOrders() {
  ...
  const { loading, data } = useQuery(CURRENT_ORDER, {
    variables: { id: getTokenFromSession() },
  });
      ...
      <div style={{ padding: "10px" }}>
        ...
        <MaterialTable
          ...
          columns={[
            ...
            { title: "Status", field: "status", cellStyle:rowData => ({ 
              'color':'#6c757d'
            }) },
          ]}
          data={dataRows}
