    ...
    const discountArea = (TotalCart) =>{
        if(TotalCart >0){
            return(
                ...
                <Button variant="contained" style={{backgroundColor:"#9c1233", color:"#fff"}} className={classes.titleItemRight}>
                    Place Order
                </Button>
            </>
            )
    ...
    return(
        ...
        <Table className={classes.table} aria-label="simple table">
            ...
            {ListCart.map((item,key) => (
                ...
                <TableCell>
                    <IconButton style={{color:"#9c1233"}} aria-label="add to shopping cart" onClick={()=>DeleteCart(key)} >
                        <CancelIcon />
                        </IconButton>
                    </TableCell>
                </TableRow>
